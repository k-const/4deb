...
dbus-user-session dia dia-shapes doublecmd-gtk doublecmd-plugins evolution evolution-plugins \
file-roller filezilla firefox-esr firefox-esr-l10n-ru flatpak fonts-ibm-plex fonts-noto-cjk-extra \
gdm3 gimp gimp-data-extras gimp-dds gimp-gap gimp-gmic gimp-gutenprint gimp-lensfun \
gimp-plugin-registry gimp-ufraw gnome-bluetooth gnome-control-center gnome-online-accounts \
gnome-screenshot gnome-session gnome-session-canberra gnome-sushi gnome-terminal gnome-tweaks \
gnome-user-docs gstreamer1.0-pulseaudio gtkam-gimp htop iptables-persistent libcanberra-pulse \
libglx-mesa0 libreoffice-calc libreoffice-evolution libreoffice-gnome libreoffice-gtk3 \
libreoffice-impress libreoffice-l10n-ru libreoffice-writer macchanger mactelnet-client \
mesa-vdpau-drivers modemmanager mpv mtr nautilus-admin nautilus-extension-gnome-terminal \
...
network-manager-ssh-gnome pavucontrol pidgin pidgin-audacious pidgin-blinklight pidgin-otr \
pidgin-plugin-pack printer-driver-all printer-driver-cups-pdf pulseaudio \
...
ttf-mscorefonts-installer ttf-unifont unace unrar unzip usb-modeswitch vim-gtk3 wireshark-gtk \
