...
dbus-user-session dia dia-shapes evolution evolution-plugins file-roller filezilla firefox-esr \
...
gnome-sushi gnome-terminal gnome-tweaks gnome-user-docs gstreamer1.0-pulseaudio gtkam-gimp \
gvfs-backends htop hunspell-en-us hunspell-ru hyphen-en-us hyphen-ru iptables-persistent \
libcanberra-pulse libglx-mesa0 libreoffice-calc libreoffice-evolution libreoffice-gnome \
libreoffice-gtk3 libreoffice-impress libreoffice-l10n-ru libreoffice-writer macchanger \
mactelnet-client mesa-vdpau-drivers modemmanager mpv mtr mythes-en-us mythes-ru nautilus-admin \
nautilus-extension-gnome-terminal nautilus-sendto nautilus-share nautilus-wipe \
network-manager-l2tp-gnome network-manager-openconnect-gnome network-manager-openvpn-gnome \
network-manager-pptp-gnome network-manager-ssh-gnome pavucontrol pidgin pidgin-audacious \
pidgin-blinklight pidgin-otr pidgin-plugin-pack printer-driver-all printer-driver-cups-pdf \
pulseaudio pulseaudio-module-bluetooth pulseaudio-module-gsettings pwgen qbittorrent qpdfview \
qpdfview-djvu-plugin qpdfview-ps-plugin qt5-style-plugins rar rtkit sipcalc speedcrunch tcpdump \
tftpd ttf-mscorefonts-installer ttf-unifont unace unrar unzip usb-modeswitch vim-gtk3 vinagre \
wireshark-gtk xdg-utils xserver-xephyr xserver-xorg xserver-xorg-input-libinput \
