...
gvfs-backends htop iptables-persistent libcanberra-pulse libglx-mesa0 libreoffice-calc \
libreoffice-evolution libreoffice-gnome libreoffice-gtk3 libreoffice-impress libreoffice-l10n-ru \
libreoffice-writer macchanger mactelnet-client mesa-vdpau-drivers modemmanager mpv mtr mythes-en-us \
mythes-ru nautilus-admin nautilus-extension-gnome-terminal nautilus-sendto nautilus-share \
nautilus-wipe network-manager-l2tp-gnome network-manager-openconnect-gnome \
