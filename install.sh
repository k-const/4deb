...
htop iptables-persistent ladspa-plugin libreoffice-calc libglx-mesa0 libreoffice-gnome \
...
network-manager-strongswan pavucontrol printer-driver-all printer-driver-cups-pdf pwgen qbittorrent \
qpdfview qpdfview-djvu-plugin qpdfview-ps-plugin qt5-style-plugins rar screengrab sipcalc tcpdump \
