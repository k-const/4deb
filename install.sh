...
fonts-ibm-plex fonts-noto-cjk-extra gdm3 gnome-screenshot gnome-session gnome-session-canberra \
gnome-sushi gnome-terminal gnome-tweaks gnome-user-docs gstreamer1.0-gtk3 htop iptables-persistent \
ladspa-plugin libreoffice-calc libglx-mesa0 libreoffice-gnome libreoffice-gtk3 libreoffice-impress \
libreoffice-l10n-ru libreoffice-writer macchanger mactelnet-client mpv mtr nautilus-admin \
