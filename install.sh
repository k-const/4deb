...
cutecom dia dia-shapes doublecmd-gtk doublecmd-plugins file-roller filezilla firefox-esr \
firefox-esr-l10n-ru fonts-ibm-plex fonts-noto-cjk-extra gdm3 gimp gimp-data-extras gimp-dds \
gimp-gap gimp-gmic gimp-gutenprint gimp-lensfun gimp-plugin-registry gimp-ufraw gtkam-gimp \
gnome-session gnome-session-canberra gnome-sushi gnome-terminal gnome-tweaks gnome-user-docs \
gstreamer1.0-gtk3 htop iptables-persistent libreoffice-calc libglx-mesa0 libreoffice-gnome \
...
network-manager-strongswan pavucontrol printer-driver-all printer-driver-cups-pdf pwgen \
qbittorrent qpdfview qpdfview-djvu-plugin qpdfview-ps-plugin qt5-style-plugins rar screengrab \
sipcalc speedcrunch tcpdump thunderbird thunderbird-l10n-ru ttf-mscorefonts-installer ttf-unifont \
unace unrar unzip vim-gtk3 wireshark-gtk xdg-utils xserver-xorg xserver-xorg-input-libinput \
